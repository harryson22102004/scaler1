...
│   ├── scenarios.py            # 11 composable scenarios with cascading faults (>=3 objectives each)
...
## Important: Task Scoring Requirements (Passes Phase 2 Validation)

**All scenarios in this repository have been updated to pass the Meta x Scaler Phase 2 Deep Validation.**

**Validation rules enforced:**
- **At least 3 tasks with graders**: Each scenario now includes a minimum of 3 defined objectives.
- **Score strictly between 0 and 1**: Total points for every scenario sum to exactly **0.99** (satisfying the $0 < \text{score} < 1$ requirement).
- **Fail-fast compliant**: Grading logic is optimized to stop early on critical failures, providing clear validator logs.

**Current Scenario Status:**

| Scenario Name | Difficulty | Objectives | Total Score | Status |
| :--- | :---: | :---: | :---: | :---: |
| Log Analysis | Easy | 3 | 0.99 | ✅ Validated |
| Permission Repair | Medium | 3 | 0.99 | ✅ Validated |
| Process Recovery | Hard | 3 | 0.99 | ✅ Validated |
| Disk Space Crisis | Medium | 3 | 0.99 | ✅ Validated |
| Cascading DB Failure | Expert | 5 | 0.99 | ✅ Validated |
| Full Incident Response | Expert | 6 | 0.99 | ✅ Validated |

*See [src/scenarios.py](src/scenarios.py) for the full catalog.*
